            ...
            if($jenis_transaksi == 1){
                if($cs['status'] == 0){
                    ...
                    if($hasil['result'] == 'true'){
                        $update3 = mysqli_query($conn,"UPDATE `tb_order` SET status = 2, `trxID` = '$orderid', status_order = '$order_status' WHERE kd_transaksi = '$merchantOrderId'") or die(mysqli_error($conn));
...
WA/TELEGRAM : '.$su['no_hp'];
                        ...
                        $insert_transaksi = mysqli_query($conn,"INSERT INTO `tb_transaksi` (`kd_transaksi`, `date`, `transaksi`, `total`, `saldo`, `note`, `providerID`, `jenis`, `metode`, `userID`, `status`) VALUES ('$merchantOrderId','$created_date','Pengembalian Dana','$subtotal',0,'Pengembalian Dana', '$providerID','1','saldo','$userID',2)") or die(mysqli_error());
...
WA/TELEGRAM : '.$su['no_hp'];
                        ...
                        $insert_transaksi = mysqli_query($conn,"INSERT INTO `tb_transaksi` (`kd_transaksi`, `date`, `transaksi`, `total`, `saldo`, `note`, `providerID`, `jenis`, `metode`, `userID`, `status`) VALUES ('$merchantOrderId','$created_date','Pengembalian Dana','$amount',0,'Pengembalian Dana', '$providerID','1','$payment_method','$userID',1)") or die(mysqli_error($conn));
            ...
            if($jenis_transaksi == 1){
                if($cs['status'] == 0){
                    ...
                    if($order_status != 'Gagal'){
                        $update3 = mysqli_query($conn,"UPDATE `tb_order` SET status = 2, status_order = '$order_status', `note` = '$message' WHERE kd_transaksi = '$merchantOrderId'") or die(mysqli_error($conn));
                        $content = '*Terima Kasih* Pesanan Anda Berhasil Diproses
...
WA/TELEGRAM : '.$su['no_hp'];
                        ...
                        $insert_transaksi = mysqli_query($conn,"INSERT INTO `tb_transaksi` (`kd_transaksi`, `date`, `transaksi`, `total`, `saldo`, `note`, `providerID`, `jenis`, `metode`, `userID`, `status`) VALUES ('$merchantOrderId','$created_date','Pengembalian Dana $productTitle','$subtotal',0,'Pengembalian Dana $productTitle', '$providerID','1','saldo','$userID',2)") or die(mysqli_error());
                        $content = '*Terima Kasih* Pesanan Anda Gagal Diproses
...
WA/TELEGRAM : '.$su['no_hp'];
                        ...
                        $update1 = mysqli_query($conn,"UPDATE `tb_balance` SET `active` = active + '$harga', `pending` = pending - $subtotal WHERE userID = '$userID'") or die(mysqli_error($conn));
                        $update3 = mysqli_query($conn,"UPDATE `tb_order` SET `status` = 3, `note` = '$order_status' WHERE kd_transaksi = '$merchantOrderId'") or die(mysqli_error($conn));
                        $insert_transaksi = mysqli_query($conn,"INSERT INTO `tb_transaksi` (`kd_transaksi`, `date`, `transaksi`, `total`, `saldo`, `note`, `providerID`, `jenis`, `metode`, `userID`, `status`) VALUES ('$merchantOrderId','$created_date','Pengembalian Dana','$subtotal',0,'Pengembalian Dana','$jenisnya','1','saldo','$userID',2)") or die(mysqli_error());
                        $content = '*Terima Kasih* Pesanan Anda Gagal Diproses
...
WA/TELEGRAM : '.$su['no_hp'];
            ...
            if($jenis_transaksi == 1){
                if($cs['status'] == 0){
                    ...
                    $post_url = 'https://v1.apigames.id/transaksi/http-get-v1?merchant='.$merchantCodes.'&secret='.$apiKeys.'&produk='.$servicess.'&tujuan='.$dataNo.$dataZone.'&ref=' . $merchantOrderId;
                    $curl1 = curl_init();
                    curl_setopt_array($curl1, array(
...
WA/TELEGRAM : '.$su['no_hp'];
                        ...
                        $order_status = $hasil['data']['status'];
                        $note = $hasil['data']['sn'];
                        $update3 = mysqli_query($conn,"UPDATE `tb_order` SET `trxID` = '$orderid', status_order = '$order_status', note = '$note', status = 2 WHERE kd_transaksi = '$merchantOrderId'") or die(mysqli_error($conn));
                        $content = '*Terima Kasih* Pesanan Anda Berhasil Diproses

      ...
      <div class="pt-5 pb-5" bis_skin_checked="1">
        <div class="container" bis_skin_checked="1">
          <div class="row" bis_skin_checked="1">
            <div class="col-lg-12 col-sm-6 text-center" bis_skin_checked="1">
              <img src="<?php echo $urlweb; ?>/upload/<?php echo $s0['image']; ?>" style="display: block; margin: 0 auto; width: auto; height: 75px; margin-bottom: 15px;" alt="logo icon">
              ...
              <p><i class="fas fa-envelope pr-3"></i>: <?php echo $s1b['email']; ?> || <i class="fas fa-headphones pr-3"></i>: 09:00 - 23:00 WIB</p>
              <hr>
            </div>
            <div class="col-lg-4 col-sm-4 col-6" bis_skin_checked="1">
              <h5 class="pb-2">Informasi</h5>
              <ul class="nav flex-column mb-4">
                ...
                ?>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo $urlweb; ?>/page/?p=<?php echo $sp['slug']; ?>"><i class="fa fa-circle-dot pr-2" style="width: 20px;"></i> <?php echo $sp['nama_page']; ?></a>
                </li>
                <?php } ?>
                <li class="nav-item">
          ...
          <div class="text-center pt-5 pb-2" bis_skin_checked="1">

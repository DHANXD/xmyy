...
WA/TELEGRAM : '.$sellerWa;
        ...
        if($ct == 0){
            ...
            if($httpCode == 200){
                ...
                ('$last_id', '$reference', '$kd_transaksi', '$metode', '$metodeBayar', '$email', '$noHp', '$harga', '0', '$subtotal', '$vaNumber', '$paymentUrl', '$statusCode', '0000-00-00 00:00:00', '$expired_time', '$jenisnya', 1, '$created_date')") or die(mysqli_error($conn));
            }
...
WA/TELEGRAM : '.$sellerWa;
        ...
        if($metodeBayar == 'BCAVA'){
            $insert = mysqli_query($conn,"INSERT INTO `tb_order` (`id_session`, `kd_transaksi`, `produkID`, `qty`, `harga`, `kode_unik`, `potongan`, `sub_total`, `voucher`, `kategori`, `title`, `userID`, `zoneID`, `nickname`, `trxID`, `services`, `status_order`, `note`, `full_name`, `email`, `no_hp`, `metode`, `created_date`, `providerID`, `jenis`, `id_user`, `status`) VALUES ('$sid', '$kd_transaksi', '$produkID', 1, '$harga', '$kode_unik', '$potongan', '$subtotal', '$voucher', '$productCategory', '$productCategory', '$productTitle', '$userID', '$zone_id', '$nickname', '', '$productCode', '', '', '$full_name', '$email', '$noHp', '$metode', '$created_date', '$jenisnya', 1, '$last_id', 0)") or die(mysqli_error($conn));

            $insert_tripay = mysqli_query($conn,"INSERT INTO `tb_tripay` 
                (`userID`, `reference`, `merchant_ref`, `payment_method`, `payment_name`, `customer_email`, `customer_phone`, `amount`, `fee`, `amount_total`, `pay_code`, `checkout_url`, `status`, `paid_time`, `expired_time`, `providerID`, `jenis_transaksi`, `created_date`) VALUES 
                ('$last_id', '', '$kd_transaksi', 'Direct_$metodeBayar', 'Bank Central Asia (BCA)', '$email', '$noHp', '$harga', '$kode_unik', '$subtotale', '', '', 'UNPAID', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '$jenisnya', 1, '$created_date')") or die(mysqli_error($conn));
        }
            ...
            $insert_tripay = mysqli_query($conn,"INSERT INTO `tb_tripay` 
                (`userID`, `reference`, `merchant_ref`, `payment_method`, `payment_name`, `customer_email`, `customer_phone`, `amount`, `fee`, `amount_total`, `pay_code`, `checkout_url`, `status`, `paid_time`, `expired_time`, `providerID`, `jenis_transaksi`, `created_date`) VALUES 
                ('$last_id', '', '$kd_transaksi', 'Direct_$metodeBayar', 'Bank Negara Indonesia (BNI)', '$email', '$noHp', '$harga', '$kode_unik', '$subtotale', '', '', 'UNPAID', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '$jenisnya', 1, '$created_date')") or die(mysqli_error($conn));
        }
            ...
            $insert_tripay = mysqli_query($conn,"INSERT INTO `tb_tripay` 
                (`userID`, `reference`, `merchant_ref`, `payment_method`, `payment_name`, `customer_email`, `customer_phone`, `amount`, `fee`, `amount_total`, `pay_code`, `checkout_url`, `status`, `paid_time`, `expired_time`, `providerID`, `jenis_transaksi`, `created_date`) VALUES 
                ('$last_id', '', '$kd_transaksi', 'Direct_$metodeBayar', 'Bank Rakyat Indonesia (BRI)', '$email', '$noHp', '$harga', '$kode_unik', '$subtotale', '', '', 'UNPAID', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '$jenisnya', 1, '$created_date')") or die(mysqli_error($conn));
        }
            ...
            $insert_tripay = mysqli_query($conn,"INSERT INTO `tb_tripay` 
                (`userID`, `reference`, `merchant_ref`, `payment_method`, `payment_name`, `customer_email`, `customer_phone`, `amount`, `fee`, `amount_total`, `pay_code`, `checkout_url`, `status`, `paid_time`, `expired_time`, `providerID`, `jenis_transaksi`, `created_date`) VALUES 
                ('$last_id', '', '$kd_transaksi', 'Direct_$metodeBayar', 'Bank Mandiri (MANDIRI)', '$email', '$noHp', '$harga', '$kode_unik', '$subtotale', '', '', 'UNPAID', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '$jenisnya', 1, '$created_date')") or die(mysqli_error($conn));
        }
        header('Location:../payment/?trxID='.$kd_transaksi);
        exit();
    }
        ...
        if($metode == 'saldo'){
            ...
            if($saldo_aktif > $subtotal){
                $insert = mysqli_query($conn,"INSERT INTO `tb_order` (`id_session`, `kd_transaksi`, `produkID`, `qty`, `harga`, `kode_unik`, `potongan`, `sub_total`, `voucher`, `kategori`, `title`, `userID`, `zoneID`, `nickname`, `trxID`, `services`, `status_order`, `note`, `full_name`, `email`, `no_hp`, `metode`, `created_date`, `providerID`, `jenis`, `id_user`, `status`) VALUES ('$sid', '$kd_transaksi', '$produkID', 1, '$subtotal', '$kode_unik', '$potongan', '$subtotal', '$voucher', '$productCategory', '$productTitle', '$userID', '$zone_id', '$nickname', '', '$productCode', '', '', '$full_name', '$email', '$noHp', '$metode', '$created_date', '$jenisnya', 1, '$last_id', 1)") or die(mysqli_error($conn));
                ...
                $insert_transaksi = mysqli_query($conn,"INSERT INTO `tb_transaksi` (`kd_transaksi`, `date`, `transaksi`, `total`, `saldo`, `note`, `providerID`, `jenis`, `metode`, `userID`, `status`) VALUES ('$kd_transaksi','$created_date','Pembelian Produk $productTitle','$subtotal',0,'Pembelian Produk $productTitle', '$jenisnya','1','saldo','$last_id',1)") or die(mysqli_error());
                ...
                if($jenisnya == 4){
                    ...
                    curl_setopt_array($curl1, array(
                        ...
                        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                        CURLOPT_CUSTOMREQUEST => 'POST',
                        CURLOPT_POSTFIELDS => array('key' => $apiKeys, 'sign' => $sign, 'type' => 'order', 'service' => $productCode, 'data_no' => $userID, 'data_zone' => $zone_id),
                    ));
                    ...
                    $post_url = 'https://v1.apigames.id/transaksi/http-get-v1?merchant='.$merchantCodes.'&secret='.$apiKeys.'&produk='.$productCode.'&tujuan='.$userID.$zone_id.'&ref=' . $kd_transaksi;
                    $curl1 = curl_init();
                    curl_setopt_array($curl1, array(

                    ...
                    <div class="card-body">
                      <?php
                        ...
                        if(isset($_GET['postID'])){
                          $catID = $_GET['postID'];
                          $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_page` WHERE id = '$catID'") or die(mysqli_error());
                  ...
                  <div class="card">
                    <div class="card-datatable table-responsive">
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          <?php
                            $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_page` ORDER BY id ASC") or die(mysqli_error());
                            $no=0;
                          ...
                          <tr>
                            ...
                            <td class="text-left" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo $s1['nama_page']; ?></td>
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/page/?postID=<?php echo $s1['id']; ?>" class="btn btn-primary btn-sm">
                                <i class="fa fa-edit"></i>
                              </a>
                              <a href="<?php echo $urlweb; ?>/function/del-page.php?id=<?php echo $s1['id']; ?>&jenis=1" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');">

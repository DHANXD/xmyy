          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">System /</span> <span class="text-muted fw-light">Settings /</span> Markup Selling
                  ...
                  <div class="card">
                    <div class="card-body">
                      <?php
                        ...
                        $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_admin` WHERE id = 1") or die(mysqli_error());
                        $s2 = mysqli_fetch_array($sql_2);
                      ?>
                      <form role="form" action="<?php echo $urlweb; ?>/function/add-admin.php" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-2">
                          <label>Satuan :</label>
                          <select class="form-control" type="text" name="satuan" required>
                            <option value=""> Pilih Satuan </option>
                            <option value="0"<?php if($s2['satuan'] == 0){ echo ' selected=selected'; } ?>> Persen </option>
                            <option value="1"<?php if($s2['satuan'] == 1){ echo ' selected=selected'; } ?>> Rupiah </option>
                          </select>
                        </div>
                        <div class="form-group mb-2">
                          <label>Markup :</label>
                          <input class="form-control" type="text" name="persen_sell" value="<?php echo $s2['persen_sell']; ?>">
                        </div>
                        <div class="form-group mb-2">
                          <label>Markup Reseller :</label>
                          <input class="form-control" type="text" name="persen_res" value="<?php echo $s2['persen_res']; ?>">
                        </div>
                        <button type="submit" name="submit" class="btn btn-primary">Publish</button>
                        <a href="<?php echo $urlweb; ?>/admin/" class="btn btn-light">Cancel</a>
                      </form>
                    </div>
                  </div>
                </div>

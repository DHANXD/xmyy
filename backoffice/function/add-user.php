<?php
    ...
    if($q > 0){
        header('location:../user/?notif=2');
    }
    else {
        $query = mysqli_query($conn,"INSERT INTO `tb_user` (`user`, `pass`, `re_pass`, `token_id`, `image`, `full_name`, `email`, `no_hp`, `level`, `join_date`, `last_login`, `status`) VALUES ('$user', '$pass', '$re_pass', '0', 'avatar5.png', '$full_name', '$email', '$no_hp', '$level', '$join_date', '$join_date', 1)") or die(mysqli_error());

...
$query = mysqli_query($conn,"UPDATE `tb_prepaid` SET `harga_jual`='$harga_jual', `harga_reseller` = '$harga_reseller'  WHERE id = '$postID'") or die(mysqli_error());
header('location:../prepaid/?do=add&catID='.$postID.'&notif=1');
exit();
?>
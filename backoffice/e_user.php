          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Dashboard /</span> Profiles
                  ...
                  <div class="card">
                    <div class="card-body">
                      <?php
                        ...
                        $userID = $u['id'];
                        $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_user` WHERE id = '$userID'") or die(mysqli_error());
                        $s2 = mysqli_fetch_array($sql_2);
                      ?>
                      <form role="form" action="<?php echo $urlweb; ?>/function/edit-user.php" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-2">
                          <label class="form-label">Username :</label>
                          <input class="form-control" type="text" name="user" value="<?php echo $s2['user']; ?>" readonly>
                          <input class="form-control" type="hidden" name="postID" value="<?php echo $s2['id']; ?>" readonly>
                        </div>
                        <div class="form-group mb-2">

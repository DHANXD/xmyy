                  ...
                  <div class="card">
                    <div class="card-body">
                      <?php
                        ...
                        if(isset($_GET['catID'])){
                          $catID = $_GET['catID'];
                          $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_reward` WHERE id = '$catID'") or die(mysqli_error());
                    ...
                    <div class="card-datatable table-responsive">
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          <?php
                            error_reporting(0);
                            $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_reward` ORDER BY id DESC") or die(mysqli_error());
                            $no=0;
                          ...
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; white-space: normal;"><?php echo $s1['title']; ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal;"><?php echo $s1['nominal']; ?></td>

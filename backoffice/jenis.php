                  ...
                  <div class="card">
                    <div class="card-datatable table-responsive">
                      <table id="default-datatable" class="invoice-list-table table border-top">
                        ...
                        <tbody>
                          <?php
                            $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_jenis` ORDER BY id ASC") or die(mysqli_error());
                            $no=0;
                          ...
                          <tr>
                            ...
                            <td class="text-left" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo $s1['image']; ?></td>
                            <td class="text-left" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?php echo $s1['jenis']; ?></td>
                            ...
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?php echo $urlweb; ?>/function/jenis-status.php?postID=<?php echo $s1['id']; ?>&status=<?php echo $s1['status']; ?>" class="btn <?php if($s1['status'] == 0){ echo 'btn-success'; } else { echo 'btn-danger'; } ?> btn-sm"><i class="fa fa-heart"></i></a>
                            </td>
                          </tr>
                          <?php } ?>
                        </tbody>

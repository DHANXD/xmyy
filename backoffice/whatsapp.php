                  ...
                  <div class="card">
                    <div class="card-body">
                      <?php
                        ...
                        $sql_2 = mysqli_query($conn,"SELECT * FROM `tb_tripayapi` WHERE id = 8") or die(mysqli_error());
                        $s2 = mysqli_fetch_array($sql_2);
                      ?>
                      <form role="form" action="<?php echo $urlweb; ?>/function/add-fonnte.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-5">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <hr>
                      <ol>
                        <li>Api Whatsapp Menggunakan pihak ketiga fonnte (<a href="https://md.fonnte.com/new/register.php?ref=31" target="_blank">Klik Disini</a> Untuk Registrasi)</li>
                        <li>Jika Belum Memiliki Akun Fonnte silahkan buat dan berlangganan paket Reguler (Rp. 66.000/Bulan)</li>
                        <li>Apabila Sudah memiliki akun masukan Api Authorization pada form yang sudah disediakan</li>
                        <li>
                          Api Whatsapp akan mengirimkan pesan untuk :
                          <ul>
                            <li>Pesanan Dibuat, Informasi Tujuan Pembayaran</li>
                            <li>Pesanan Dibayar, Informasi Pembayaran Diterima</li>
                            <li>Pesanan Diproses, Informasi Pesanan Sukses atau Gagal</li>
                          </ul>
                        </li>
                      </ol>
                    </div>

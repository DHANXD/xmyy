                    ...
                    <div class="tab-pane fade show active" id="game" role="tabpanel">
                      <div class="card-datatable table-responsive">
                        <table id="default-datatable" class="invoice-list-table table border-top">
                          ...
                          <tbody>
                            <?php
                              $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_produk` WHERE jenis = 9 AND product_type = 1 ORDER BY id ASC") or die(mysqli_error());
                              $no=0;
                    ...
                    <div class="tab-pane fade" id="premium" role="tabpanel">
                      <div class="card-datatable table-responsive">
                        <table id="default-datatable1" class="invoice-list-table table border-top">
                          ...
                          <tbody>
                            <?php
                              $sql_1 = mysqli_query($conn,"SELECT * FROM `tb_produk` WHERE jenis = 9 AND product_type = 2 ORDER BY id ASC") or die(mysqli_error());
                              $no=0;
                              while($s1 = mysqli_fetch_array($sql_1)){
                                $no++;
                                $jenis = $s1['jenis'];

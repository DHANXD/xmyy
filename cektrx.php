                ...
                <div class="card-body">
                  <form role="form" class="mb-3" action="" method="GET">
                    ...
                    <div class="form-group mb-3">
                      <input type="text" name="trxNum" class="form-control" value="<?php if(isset($_GET['trxNum'])) { echo $_GET['trxNum']; } ?>" required>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                    <a href="#"><button class="btn btn-success btn-sm"><strong><?php echo $ct['status_order']; ?></strong></button></a>
                    </div>
                  </div>
                  <hr style="background-color: #b8b8b8; opacity: .5;">
                  <div class="row">

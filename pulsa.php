...
<head>
  ...
  <title>PULSA <?php echo $s6['kategori']; ?> - <?php echo $s0['instansi']; ?></title>
  <meta name="description" content="<?php echo $s0['deskripsi']; ?>">
  <meta name="keywords" content="<?php echo $s0['keyword']; ?>">
  <meta property="og:title" content="PULSA <?php echo $s6['kategori']; ?> - <?php echo $s0['instansi']; ?>"/>
                  ...
                  <div class="form-row pt-3">
                    ...
                    <div class="col-6"> 
                      <select name="zone_id" id="zoneID" class="form-control">  
                        ...
                        ?>
                        <option value="<?php echo str_replace(' ','-',$s31['kategori']).'_'.$s31['brand']; ?>"><?php echo strtoupper(str_replace('-',' ',$s31['kategori'])); ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  ...
                  <div class="row pt-3 pl-2 pr-2 mb-2" id="resultpulsa">
                    <div class="col-12">
                            <div class="alert alert-warning alert-dismissible mt-3 mb-0" role="alert">
                              ...
                              <span><strong>Information!</strong> Silahkan Pilih jenis Layanan.</span>
                              </div>
                            </div>
                          </div>
                    </div>  
    ...
    <script>
      ...
      $(document).ready(function() {
        ...
        $("#submitId").click(function () {
            uri = "<?php echo $urlweb; ?>/get_token.php?userID="+$("#userID").val()+"&produkID="+$('input:radio[name=produkID]:checked').val()+"&metode="+$('input:radio[name=metode]:checked').val()+"&IDuser="+$("#IDuser").val()+"&noHp="+$("#noHp").val()+"&voucher="+$("#voucher").val();
